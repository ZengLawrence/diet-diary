...
export default class FoodDescriptionParser extends antlr4.Parser {
    ...
    static symbolicNames = [ null, null, null, null, "STRING", "DIGIT", 
                             "WS" ];
	...
	measurement() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << FoodDescriptionParser.T__0) | (1 << FoodDescriptionParser.T__1) | (1 << FoodDescriptionParser.T__2))) !== 0)) {
	            this.state = 22;
	            this.unit();
	        }
...
FoodDescriptionParser.STRING = 4;
FoodDescriptionParser.DIGIT = 5;
